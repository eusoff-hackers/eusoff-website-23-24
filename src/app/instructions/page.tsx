...
const InstructionsPage = () => {
  return (
    <main className="bg-gradient-to-tl from-slate-300 to-slate-200 h-full">
      <article className="bg-slate-200 shadow-2xl m-auto w-full py-5 rounded-lg p-2 border-4 border-slate-800">
        ...
        <h1 className="text-black md:text-4xl text-2xl font-black px-2 font-mono inline">
          Instructions
        </h1>


        <div className="text-black md:text-2xl text-base px-2 py-1 font-mono leading-normal">
