...
const ProfilePage: NextPage<user_data> = ({userData}) => {
  ...
  return (
    <main className="bg-gradient-to-tl from-slate-200 to-slate-300 h-screen w-screen">
      ...
      <div className="bg-slate-200 mt-10 w-1/2 shadow-2xl text-3xl font-mono rounded-lg object-center  text-center
        ...
        <h2 className="text-green-500 font-bold hover:text-green-600" > <b className="font-light">Points</b> <br /> {userData.points}</h2>
        <br />
        <h2 className="text-orange-500 font-bold hover:text-orange-600"><b className="font-light">Bids</b> <br />{userData.bids} </h2>
      </div>
    </main>
  )
}
